...
\begin{innerlist}
\item[]	Visiting Student Research Collaborator, September-December 2011.
\item[] Sponsors: Professor Bo Honor\'{e} and Ulrich M\"{u}ller.
\end{innerlist}
...
\item[] DEUG (2 year undergrad degree) Mathematics and Computer Sciences (MIAS: Mathematics Informatiques et Applications aux Sciences), June 2004.
\end{outerlist}
...
\item[] \textbf{Refereed Publications}\\
    \begin{innerlist}
 \item[]Kock, Callot, Caner, Kock, and Riquelme: {Sharp threshold detection based on sup-norm error rates in high-dimensional models"
description}. \textit{conditionally accepted, Journal of Business \& Economic Statistics}.    
\item[]Kock and Callot: {Oracle Inequalities for High Dimensional Vector Autoregressions}. \textit{in press, Journal of Econometrics}. 
\item[]Callot and Kock: {Oracle Efficient Estimation and Forecasting with the Adaptive Lasso and the Adaptive Group Lasso in Vector Autoregressions}, forthcoming in \textit{Essays in Nonlinear Time Series Econometrics.} Oxford University Press.
\item[]Callot and Paldam: {Natural funnel asymmetries. A simulation analysis of the three basic tools of meta analysis}, \textit{Research Synthesis Methods Volume 2, Issue 2, pages 84–102, June 2011}
    \end{innerlist}
...
\item[]Callot and Kristensen: {Regularized Estimation of Structural Instability in Factor Models: The US Macroeconomy and the Great Moderation}, \textit{Revision requested.} 
