...
\section{Expertise}
%
Forcasting, Time-series, Causal analysis, Machine Learning, Statistics, Econometrics, Neural Networks, Macroeconomics, Financial econometrics.


\section{Current Positions}
\textbf{Senior Economist}, Amazon Development Center, Berlin. Since June 2016,
\begin{innerlist}
...
\item[2005-2006] Statistician, SITELESC, Paris, France. Populating and management of a small business data base.
...
All publications are peer-reviewed. The latest version of the every paper with replication files is available on my website \href{https://lcallot.github.io/papers}{(link)}.
