...
description}. \textit{In press, Journal of Business \& Economic Statistics}.    
\item[]Kock and Callot: {Oracle Inequalities for High Dimensional Vector Autoregressions}. \textit{Journal of Econometrics, Volume 186, Issue 2}. 
\item[]Callot and Kock: {Oracle Efficient Estimation and Forecasting with the Adaptive Lasso and the Adaptive Group Lasso in Vector Autoregressions}, \textit{Essays in Nonlinear Time Series Econometrics, chapter 10.} Oxford University Press.
