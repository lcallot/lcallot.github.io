...
\item[] \textbf{Refereed Publications}\\
    \begin{innerlist}
\item[]Kock, Anders Bredahl and Callot, Laurent A.F: {Oracle Inequalities for High Dimensional Vector Autoregressions}. \textit{Conditionally accepted at the Journal of Econometrics}.
\item[]Callot, Laurent A.F and Kock, Anders Bredahl: {Oracle Efficient Estimation and Forecasting with the Adaptive Lasso and the Adaptive Group Lasso in Vector Autoregressions}, forthcoming in \textit{Essays in Nonlinear Time Series Econometrics. Eds. N. Haldrup, and M. Meitz, and P. Saikkonen} Oxford University Press 2014.
...
\item[] \textbf{Working papers}\\
    \begin{outerlist}
\item[]Callot, Laurent A.F: {A Bootstrap Co-integration Rank Test for Panels of VAR Models}, \textit{Submitted to the Econometrics Reviews.}
\item[]Callot, Laurent A.F: {Estimating and Testing for a Common Co-integration Space in Large Panel VAR}, \textit{Working paper.}
\item[]Callot, Laurent A.F and Kock, Anders B. and Medeiros, Marcelo C: {Forecasting of Large Realized Covariance Matrices and Portfolio Choice}, \textit{Working paper.}
\item[]Callot, Laurent A.F and Kristensen, Johannes Tang: {Factor models with Parsimoniously Time Varying Parameters}, \textit{Working paper.}
    \end{outerlist}
\end{outerlist}
...
\item[] \textit{Lecturer}\\
    \begin{innerlist}
    	\item[]Introductory Econometrics, Spring 2014, VU Amsterdam.
...
\item[] \textit{Teaching Assistant}\\
    \begin{innerlist}
    \item[]Statistics, Spring 2014, VU Amsterdam.
    \item[]Business Mathematics, Fall 2013, VU Amsterdam.
...
\section{Refereeing}
    ...
    \item[]The Energy Journal ($\times 3$).
